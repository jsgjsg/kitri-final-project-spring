...
public interface ReviewCommentMapper {
    ...
    @Insert("INSERT INTO ReviewComment(review_id, content, create_at) VALUES (#{review_id}, #{content}, #{create_at}}, #{satisfaction})")
    void reviewCommentInsert(ReviewComment comment);
    @Update("UPDATE ReviewComment SET content=#{content} WHERE id=#{id}")
